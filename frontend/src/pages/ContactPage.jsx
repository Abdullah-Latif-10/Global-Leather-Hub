...
const offices = [
  ...
  },
  {
    ...
    address: "Plot 47, Quaid-e-Azam Industrial Estate, Lahore",
    phone: "+92 42 3576 1234",
    email: "factory@globalleatherhub.com",
    hours: "Mon–Sat  8 AM – 5 PM PKT",
    flag: "🇵🇰",
  },
  {
    city: "London",
    ...
    email: "europe@globalleatherhub.com",
    hours: "Mon–Fri  9 AM – 5:30 PM GMT",
    flag: "🇬🇧",
  },
];
...
const inquiryTypes = [
  ...
  "Custom / Private Label Order",
  "Sample Request",
  "Shipping & Logistics",
  "Returns & Quality Issue",
...
const faqs = [
  {
    ...
    a: "Jackets: 50 units · Belts: 100 units · Wallets: 200 units. Custom/branded orders may differ.",
  },
  {
    q: "How long does production take?",
    a: "Standard 3–5 weeks. Rush production (2 weeks) available for orders under 500 units at added cost.",
  },
  {
    q: "Do you offer private label / OEM services?",
    a: "Yes — custom labels, packaging, and branding. Minimum 200 units per style for private label.",
  },
  {
    q: "What payment methods do you accept?",
    a: "Wire Transfer (T/T), Letter of Credit (LC), and business credit cards. 30–50% deposit required.",
  },
  {
    q: "Can I request product samples first?",
    a: "Yes, samples at cost + shipping. Fees refunded on qualifying bulk orders within 90 days.",
  },
  {
    q: "Do you ship worldwide?",
    a: "We ship to 50+ countries via DHL, FedEx, and freight forwarders with full customs documentation.",
  },
];
...
export default function ContactPage() {
  ...
  const validate = () => {
    ...
    if (!form.message.trim()) e.message = "Message is required";
      ...
      e.message = "Please provide more detail (min 20 chars)";
    setErrors(e);
    ...
    <div className="bg-canvas min-h-screen page-enter">
      ...
      <section className="relative pt-0 pb-0 min-h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pb-20 pt-36 w-full">
          ...
          <p className="text-fog font-light text-base max-w-xl leading-relaxed animate-fade-up stagger-2">
            Whether you're placing your first wholesale order or scaling an
            existing partnership, our team responds within 24 hours.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-wrap gap-6 items-center justify-center md:justify-between">
            {[
              ...
              >
                <p
                  className="text-tan text-lg"
                  style={{ fontFamily: '"Playfair Display", serif' }}
                >
                  {value}
                </p>
                <p className="text-paper/40 text-[10px] tracking-widest uppercase">
                  {label}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-12 reveal">
          ...
          >
            Find Us{" "}
            <em style={{ fontStyle: "italic", color: "#8B5E3C" }}>Worldwide</em>
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {offices.map(
            ({ city, role, address, phone, email, hours, flag }, i) => (
              <div
                key={city}
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-tan text-[11px] tracking-wide font-medium">
                      {role}
                    </p>
                  </div>
                </div>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div
                      key={text}
                      className="flex items-start gap-2.5 text-xs text-fog"
                    >
            ...
            <div className="lg:col-span-2 space-y-6 reveal-left">
              ...
              {[
                {
                  ...
                  value: "hello@globalleatherhub.com",
                  href: "mailto:hello@globalleatherhub.com",
                },
                {
                  icon: Phone,
                  label: "Sales Hotline",
                ...
                },
                {
                  icon: Globe,
                  label: "Website",
                  value: "www.globalleatherhub.com",
                  href: "#",
                },
                ...
                >
                  ...
                  <div>
                    <p className="text-fog text-[10px] uppercase tracking-widest">
                      {label}
                    </p>
                    <p className="text-espresso text-sm font-medium group-hover:text-sienna transition-colors duration-200">
                      {value}
                    </p>
                  </div>
                </a>
              ...
              <div className="card flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-fog text-[10px] mt-0.5">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="card space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        <Building2 className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-fog/50" />
                        <input
                          name="company"
                          value={form.company}
                          onChange={handleChange}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Globe className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-fog/50" />
                        <input
                          name="country"
                          value={form.country}
                          onChange={handleChange}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Package className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-fog/50" />
                      <select
                        name="inquiryType"
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      {errors.message ? (
                        <p className="text-[11px] text-rust flex items-center gap-1 animate-fade-in">
                          <AlertCircle className="w-3 h-3" />
                          {errors.message}
                        </p>
                      ) : (
                      ...
                      <span
                        className={`text-[10px] transition-colors duration-200 ${form.message.length < 20 ? "text-fog/40" : "text-sage"}`}
                      >
                  ...
                  <p className="text-center text-fog/40 text-[11px]">
      ...
      <section className="py-24 max-w-2xl mx-auto px-6 lg:px-10">
        <div className="mb-12 reveal">
          ...
          >
            Frequently{" "}
            <em style={{ fontStyle: "italic", color: "#8B5E3C" }}>Asked</em>
          </h2>
        </div>
        <div className="space-y-2">
          {faqs.map(({ q, a }, i) => (
            ...
            >
              ...
              >
                <span className="text-espresso text-sm font-medium pr-4 group-hover:text-sienna transition-colors duration-200">
                  {q}
                </span>
                <ChevronDown
                  className={`w-4 h-4 text-tan flex-shrink-0 transition-transform duration-300 ${openFaq === i ? "rotate-180" : ""}`}
                />
              </button>
              <div
                className={`faq-answer ${openFaq === i ? "open" : "closed"}`}
              >
        ...
        <p className="text-center text-fog/50 text-xs mt-8">
          ...
          <a
            href="mailto:hello@globalleatherhub.com"
            className="text-tan hover:text-sienna transition-colors link-underline"
          >
            Email our team
          </a>
        </p>
